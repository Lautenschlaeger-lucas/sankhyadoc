'use client';
import {ArrowRight, BookOpen, Code2, Plug, Check} from 'lucide-react';
...
export function IntegrationHome({onSelect}:{onSelect:(mode:string)=>void}) {
  return <div className="integration-home">
    ...
    <header className="portal-header"><img src="brand/magis5.png" alt="Magis5 by Sankhya"/><span><BookOpen size={16}/> Central de implantação</span></header>
    <main id="choose-integration" className="portal-main">
      ...
      <div className="integration-choices">
        <button className="integration-choice choice-sankhya" onClick={()=>onSelect('sankhya')}>
          <div className="choice-visual" aria-hidden="true"><span className="choice-node"><Plug size={34}/></span><span className="choice-connection"/><span className="choice-destination">MG5</span></div>
        ...
        <button className="integration-choice choice-api" onClick={()=>onSelect('api')}>
          <div className="choice-visual" aria-hidden="true"><span className="choice-node"><Code2 size={34}/></span><span className="choice-connection"/><span className="choice-destination">MG5</span></div>
